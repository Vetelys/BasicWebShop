...
(async() => {
  ...
  try {
    ...
    users.forEach(user => {
      ...
      userContainer.querySelector('.user-email').id = `email-${id}`;
      userContainer.querySelector('.user-name').id = `name-${id}`;
      userContainer.querySelector('.user-role').id = `role-${id}`;

      userContainer.querySelector('.user-email').innerHTML = email;
      userContainer.querySelector('.user-name').innerHTML = name;
      userContainer.querySelector('.user-role').innerHTML = role;
