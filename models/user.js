...
const userSchema = new Schema({
  ...
  name: { type: String, required: true, trim: true, minlegth: SCHEMA_DEFAULTS.name.minLength, maxLength: SCHEMA_DEFAULTS.name.maxLength 
  ...
  email: { type: String, required: true, trim: true, match: SCHEMA_DEFAULTS.email.match, unique: true
  ...
  // }
  password: { type: String, required: true, minlength: SCHEMA_DEFAULTS.password.minLength, set: hash
  },
  // for 'role'
  // set type
  // and the following validators:
  //  required, trim, lowercase, enum,    default
  role: { type: String, required: true, trim: true, lowercase: true, enum: SCHEMA_DEFAULTS.role.values, default: SCHEMA_DEFAULTS.role.defaultValue
